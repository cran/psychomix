...
\fancyfoot[LO,LE]{\small Copyright {\copyright} 2014 The Author(s)}
\fancypagestyle{plain}{
\fancyhf{}
\fancyfoot[LO,LE]{\small This is a preprint of an article accepted for publication in \textit{Educational and Psychological Measurement}.
  \doi{10.1177/0013164414536183} \\
  Copyright~{\copyright} 2014 The Author(s). \url{http://epm.sagepub.com/}.
  }
}
