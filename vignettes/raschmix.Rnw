...
The third component displays a zigzag pattern which indicates that
...
In the second component, there are no big differences in the estimated
...
extreme by subjects in this component. In components~1 and~3, the
situation is also not very relevant but subjects differentiate between
the three verbal responses. This is best visible in component~1 where item
...
moderate response. In component~3 this pattern is also visible albeit
not as prominently as in component~1.
